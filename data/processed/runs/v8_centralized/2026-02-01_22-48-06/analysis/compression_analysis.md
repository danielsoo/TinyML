...
| **Run (날짜_시간)** | 2026-02-01_22-48-06 |
| **Data Version** | cicids2017_max1500k |
| **Generated** | 2026-02-01 22:48:52 |## Run / Training Configuration
...
| Compressed | 0.0206 | 18,772 | 0.2162 | 0.3538 | 0.65 |
...
|-------|-------------|-----------------|-----------------|----------------|----------------|
| Original | - | - | - | - | **Baseline** |
| Compressed | -89.96% ↓ | -13.0623% ↓ | +0.1137% ↑ | +44.24% ↑ | ✅ Mostly Better |
