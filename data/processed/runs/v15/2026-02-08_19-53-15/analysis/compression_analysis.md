...
|------|----|
| **Version** | v15 |
| **Run (datetime)** | 2026-02-08_19-53-15 |
| **Data Version** | cicids2017_max1500k_bal4.0 |
| **Generated** | 2026-02-08 19:53:59 |
...
|-------|-----------|------------|----------|----------|--------------|
| Original | 0.7839 | 205,777 | 0.8241 | 0.0000 | 2.23 |
...
|-------|-------------|-----------------|-----------------|----------------|----------------|
| Original | - | - | - | - | **Baseline** |
| Compressed (PTQ) | -91.38% ↓ | +7.7640% ↑ | +77.8645% ↑ | -75.26% ↓ | ✅ All Improved |
