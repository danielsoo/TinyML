...
|------|----|
| **Version** | v23 |
| **Run (datetime)** | 2026-02-24_09-10-51 |
| **Data Version** | cicids2017_max2000k_bal4.0 |
| **Generated** | 2026-02-24 09:11:49 |
...
|-------|-----------|------------|----------|----------|---------------|------------------|--------------|
| Baseline | 0.7797 | 204,880 | 0.1801 | 0.3022 | 0.0031 | 0.9941 | 1.89 |
| Traditional+PTQ | 0.0676 | 61,969 | 0.2204 | 0.3129 | 0.0521 | 1.0000 | 0.49 |
| Traditional+QAT | 0.0635 | 62,048 | 0.9627 | 0.8997 | 0.9671 | 0.9873 | 0.48 |
| QAT+PTQ | 0.0654 | 61,520 | 0.1776 | 0.3016 | 0.0001 | 1.0000 | 0.48 |
| QAT+QAT | 0.0635 | 62,048 | 0.9605 | 0.8912 | 0.9712 | 0.9806 | 0.48 |
...
|-------|-------------|-----------------|-----------------|----------------|----------------|
| Baseline | - | - | - | - | **Baseline** |
| Traditional+PTQ | -91.33% ↓ | +4.0299% ↑ | +1.0751% ↑ | -74.22% ↓ | ✅ All Improved |
| Traditional+QAT | -91.85% ↓ | +78.2603% ↑ | +59.7533% ↑ | -74.47% ↓ | ✅ All Improved |
| QAT+PTQ | -91.61% ↓ | -0.2459% ↓ | -0.0613% ↓ | -74.83% ↓ | ✅ Mostly Better |
| QAT+QAT | -91.85% ↓ | +78.0427% ↑ | +58.9076% ↑ | -74.44% ↓ | ✅ All Improved |
...
- **Recall**: 0.9999
- **F1-Score**: 0.3022
- **Normal Recall** (of actual normal, % predicted as normal): 0.0031
- **Normal Precision** (of predicted normal, % actually normal): 0.9941
- **Avg Latency**: 1.89 ms
- **Samples/sec**: 52871.60
...
- **Recall**: 0.9423
- **F1-Score**: 0.8997
- **Normal Recall** (of actual normal, % predicted as normal): 0.9671
- **Normal Precision** (of predicted normal, % actually normal): 0.9873
- **Avg Latency**: 0.48 ms
...
- **Recall**: 0.9111
- **F1-Score**: 0.8912
- **Normal Recall** (of actual normal, % predicted as normal): 0.9712
- **Normal Precision** (of predicted normal, % actually normal): 0.9806
- **Avg Latency**: 0.48 ms
