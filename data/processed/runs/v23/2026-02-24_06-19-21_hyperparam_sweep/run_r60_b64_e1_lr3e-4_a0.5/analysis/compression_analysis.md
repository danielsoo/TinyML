...
|------|----|
| **Version** | v23 |
| **Run (datetime)** | 2026-02-24_07-01-04 |
| **Data Version** | cicids2017_max2000k_bal4.0 |
| **Generated** | 2026-02-24 07:02:04 |
...
|-------|-----------|------------|----------|----------|---------------|------------------|--------------|
| Baseline | 0.7797 | 204,880 | 0.1775 | 0.3015 | 0.0000 | 0.0000 | 1.96 |
| Traditional+PTQ | 0.0676 | 61,969 | 0.2204 | 0.3129 | 0.0521 | 1.0000 | 0.48 |
| Traditional+QAT | 0.0635 | 62,048 | 0.9641 | 0.9023 | 0.9709 | 0.9853 | 0.48 |
| QAT+PTQ | 0.0654 | 61,520 | 0.1775 | 0.3015 | 0.0000 | 0.0000 | 0.48 |
| QAT+QAT | 0.0635 | 62,048 | 0.9599 | 0.8894 | 0.9711 | 0.9800 | 0.48 |
...
|-------|-------------|-----------------|-----------------|----------------|----------------|
| Baseline | - | - | - | - | **Baseline** |
| Traditional+PTQ | -91.33% ↓ | +4.2870% ↑ | +1.1396% ↑ | -75.67% ↓ | ✅ All Improved |
| Traditional+QAT | -91.85% ↓ | +78.6618% ↑ | +60.0800% ↑ | -75.50% ↓ | ✅ All Improved |
| QAT+PTQ | -91.61% ↓ | +0.0003% ↑ | +0.0004% ↑ | -75.66% ↓ | ✅ All Improved |
| QAT+QAT | -91.85% ↓ | +78.2365% ↑ | +58.7853% ↑ | -75.44% ↓ | ✅ All Improved |
...
- **Recall**: 0.9329
- **F1-Score**: 0.9023
- **Normal Recall** (of actual normal, % predicted as normal): 0.9709
...
- **Recall**: 0.9082
- **F1-Score**: 0.8894
- **Normal Recall** (of actual normal, % predicted as normal): 0.9711
- **Normal Precision** (of predicted normal, % actually normal): 0.9800
- **Avg Latency**: 0.48 ms
- **Samples/sec**: 208226.38
- **Compression Ratio**: 12.28x
