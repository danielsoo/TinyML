...
def export_tflite(
    ...
    # Always strip BatchNorm/Dropout before TFLite export.
    # TFLite's native BN conversion can produce wrong outputs (predictions skewed toward 0, F1=0).
    # BN fold preserves equivalent inference; Compressed (PTQ) uses it and gets correct F1.
    try:
