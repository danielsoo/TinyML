...
class CompressionAnalyzer:
    ...
    def __init__(
        ...
        print(f"📌 Run version: {self.version} | Data version: {self.data_version}")
    ...
    def _append_version_summary(self, df: pd.DataFrame):
        ...
        summary_path = self.output_dir.parent / "VERSIONS.md"
        ...
        header = "| Version | Data | Best Acc | Best F1 | Orig (MB) | Comp (MB) | Ratio | Date |\n"
        header += "|---------|------|----------|---------|-----------|-----------|-------|------|\n"
        line = f"| {self.version} | {self.data_version} | {best_acc:.4f} | {best_f1:.4f} | {size_orig:.3f} | {size_comp or 0:.3f} | {ratio} | {datetime.now().strftime('%Y-%m-%d %H:%M')} |\n"
